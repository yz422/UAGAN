...
from data.mnist_fashionmnist_font_dataset import MNISTFashionMNISTFontDataset


class MNISTFashionMNISTFontSplitDataset(BaseDataset):

    def __init__(self, opt):

        self.split_db = []
        for i in range(10):
            self.split_db.append(MNISTFashionMNISTFontDataset(opt, i))
