...
class MNISTFontDataset(BaseDataset):
    ...
    def __init__(self, opt, idx=None):
        ...
        if idx is None:
            h5_name = "train_MNIST_font.h5"
        else:
            # h5_name = 'train_MNIST_unique_font_uniform_{:d}.h5'.format(idx)
            h5_name = 'train_MNIST_and_font_uniform_{:d}.h5'.format(idx)
