...
from data.mnist_fashionmnist_dataset import MNISTFashionMNISTDataset


class MNISTFashionMNISTSplitDataset(BaseDataset):

    def __init__(self, opt):

        self.split_db = []
        for i in range(10):
            self.split_db.append(MNISTFashionMNISTDataset(opt, i))
